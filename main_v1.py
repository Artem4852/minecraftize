...
parser = argparse.ArgumentParser(description="Make an image from minecraft blocks.")
parser.add_argument("-p", "--path", type=str, help="Path to the image.")
parser.add_argument("-t", "--thread_num", type=int, help="Number of threads to use.", required=False, default=10)
